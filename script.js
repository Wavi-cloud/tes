...
function init() {
    ...
    // Mulai flash sale rotasi (setiap 3 jam) — demo 30 detik
...
function startFlashSaleRotation() {
    rotateFlashSale();
    // Untuk demo, gunakan 30 detik. Ganti ke 10800000 (3 jam) untuk production
...
function rotateFlashSale() {
    ...
    // Ambil 5 produk random (kecuali student discount)
...
function attachEvents() {
    ...
    // ============================================================
    // BANNER SLIDER (swipe + auto + klik) — DIPERBAIKI
    // ============================================================
    let currentBanner = 0;
    ...
    if (slides.length > 0) {
        ...
        // --- Klik pada slide (tetap berfungsi) ---
